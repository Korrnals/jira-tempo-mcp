...
Пользователи без worklog'ов перечислены в сводке под «Без отработанного времени».
...
> **Внимание:** Python-шаблоны выполняют произвольный код. Загружайте
